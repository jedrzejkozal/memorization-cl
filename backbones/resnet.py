...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes: int, planes: int, stride: int = 1, norm_layer=nn.BatchNorm2d) -> None:
        """
...
class ResNet(MammothBackbone):
    ...
    def __init__(self, block: BasicBlock, num_blocks: List[int],
                 num_classes: int, nf: int, norm_layer=nn.BatchNorm2d) -> None:
        """
...
def resnet18(n_classes: int, width: int = 1, pretrained: bool = False, **kwargs) -> ResNet:
    """
...
def resnet50(n_classes: int, width: int = 1, pretrained: bool = False, **kwargs) -> ResNet:
    ...
    if pretrained:
        ...
        model = torchvision.models.resnet.resnet50(num_classes=1000, weights=weights, width_per_group=width_per_group, **kwargs)
        model.classifier[1] = nn.Linear(model.last_channel, n_classes)
    else:
        model = torchvision.models.resnet.resnet50(num_classes=n_classes, weights=None, width_per_group=width_per_group, **kwargs)
