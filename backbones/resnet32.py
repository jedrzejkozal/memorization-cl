...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, num_features=64, norm_layer=nn.BatchNorm2d):
        self.inplanes = 16
...
def resnet32(n_classes: int, width: int = 1, pretrained: bool = False, **kwargs):
    if pretrained:
        raise NotImplementedError
    # change n=3 for ResNet-20, and n=9 for ResNet-56
    n = 5
    nf = int(16*width)
    model = ResNet(BasicBlock, [n, n, n], n_classes, nf, **kwargs)
    return model
