...
def resnet18_rep(n_classes: int, width: int = 1, pretrained: bool = False):
...
def resnet34_rep(n_classes: int, width: int = 1, pretrained: bool = False):
...
def get_all_backbones():
    return ['resnet18_rep', 'resnet34_rep']
