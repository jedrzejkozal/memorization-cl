...
best_args = {
    ...
    'seq-cifar100': {
        ...
        'fetril': {
            -1: {'lr': 0.1, 'n_epochs': 200, 'batch_size': 128, 'svc_regularization': 1.0, 'svc_tolerance': 0.0001,
                 'optim_mom': 0.9, 'optim_wd': 0.0001, 'additional_augmentations': 'store_true'}
        },
        'seed': {
            -1: {'lr': 0.05, 'n_epochs': 200, 'backbone': 'resnet32', 'gmms': 1, 'use_multivariate': 'store_true', 'tau': 3,
                 'batch_size': 128, 'optim_wd': 5e-4, 'additional_augmentations': 'store_true'}
        },
